...
import { RincianPekerjaanSeeder } from './rincian-pekerjaan-seeder';
...
export class SeedService {
  ...
  async run() {
    ...
    const rincianPekerjaanSeeder = new RincianPekerjaanSeeder(this.prisma);
    ...
    await rincianPekerjaanSeeder.seed();
